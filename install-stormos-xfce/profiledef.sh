...
file_permissions=(
  ...
  ["/etc/skelDesktop/calamares.desktop"]="0:0:755"
  ["/etc/skelDesktop/abif.desktop"]="0:0:755"
  ["/etc/skelDesktop/stormos_browser.desktop"]="0:0:755"
  ["/etc/skelDesktop/system-tool.desktop"]="0:0:755"
)
