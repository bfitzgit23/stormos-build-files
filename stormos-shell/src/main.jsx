...
function SettingsWindow({ close, minimize }) {
  ...
  const renderSection = () => {
    ...
    return <><h2>Appearance</h2><p>Configure the StormOS visual experience.</p><div className="setting-card"><div><strong>Accent color</strong><small>Used for highlights, focus rings, and active controls.</small></div><select value={accent} onChange={e=>setAccent(e.target.value)}><option value="electric-blue">Electric Blue</option><option value="neon-purple">Neon Purple</option><option value="storm-green">Storm Green</option></select></div><div className="setting-card"><div><strong>GTK theme</strong><small>Use the bundled StormOS GTK theme.</small></div><select defaultValue="Arc-BLACK-ICE"><option>Arc-BLACK-ICE</option><option>Adwaita-dark</option><option>Adwaita</option></select></div><div className="setting-card"><div><strong>Icon theme</strong><small>Use the bundled StormOS icon set.</small></div><select defaultValue="Qogir"><option>Qogir</option><option>Adwaita</option><option>hicolor</option></select></div><div className="setting-card"><div><strong>Cursor theme</strong><small>Choose the pointer appearance.</small></div><select defaultValue="default"><option value="default">System Default</option><option>Adwaita</option><option>Bibata</option></select></div></>;
  };
